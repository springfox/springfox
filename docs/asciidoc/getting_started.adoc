...
<2> Import the configuration from the `springfox-data-rest` module as shown below
...
<1> add the `springfox-bean-validators` dependency.
...
<2> Import the configuration from the `springfox-bean-validators` module as shown below
...
http://mvnrepository.com/artifact/io.springfox/springfox-swagger-ui-rfc6570/0.9.4[experimental swagger-ui].
...
----
dependencies {
    compile 'io.springfox:springfox-swagger-ui-rfc6570:0.9.4'
}
----
...
<dependency>
    <groupId>io.springfox</groupId>
    <artifactId>io.springfox:springfox-swagger-ui-rfc6570</artifactId>
    <version>0.9.4</version>
</dependency>
----

2. Enable url templating; (http://springfox.github.io/springfox/docs/current/#springfox-swagger2-with-spring-mvc-and-spring-boot[see #21])
