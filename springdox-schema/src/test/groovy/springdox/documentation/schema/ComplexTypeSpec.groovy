...
class ComplexTypeSpec extends Specification {
  def "complex type properties are inferred correctly"() {
    ...
    where:
      ...
      "category"   | Category     |  "Category"   |"springdox.documentation.schema.Category"
  ...
  def "recursive type properties are inferred correctly"() {
    ...
    where:
      ...
      "parent" | RecursiveType  | "springdox.documentation.schema.RecursiveType"
  }
  ...
  def "inherited type properties are inferred correctly"() {
    ...
    where:
      ...
      "category"          | Category      | "Category" | 'reference'  | "springdox.documentation.schema.Category"
