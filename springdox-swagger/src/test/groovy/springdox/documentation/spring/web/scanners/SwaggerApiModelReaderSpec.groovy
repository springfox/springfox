...
//      println model.subTypes()
  ...
  def "Annotated model"() {
    ...
    then:
      ...
      model.getQualifiedType() == 'springdox.documentation.spring.web.dummy.DummyModels$AnnotatedBusinessModel'
  ...
  def "Should pull models from Api Operation response class"() {
    ...
    then:
      models['FunkyBusiness'].getQualifiedType() == 'springdox.documentation.spring.web.dummy.DummyModels$FunkyBusiness'
  }
  ...
  def "Should pull models from operation's ApiResponse annotations"() {
    ...
    then:
      models.size() == 2
      models['RestError'].getQualifiedType() == 'springdox.documentation.spring.web.dummy.RestError'
