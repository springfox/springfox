...
import springfox.documentation.core.schema.JustAnotherClass

import static springfox.documentation.core.builders.RequestHandlerSelectors.basePackage
import static springfox.documentation.core.builders.RequestHandlerSelectors.none
...
class RequestHandlerSelectorsSpec extends Specification {
  ...
  def "basePackage predicate matches RequestHandlers with given Class Annotation" () {
    ...
    when:
      def handlerMethod = new HandlerMethod(clazz, methodName)
    then:
      basePackage("springfox.documentation.core.builders")
