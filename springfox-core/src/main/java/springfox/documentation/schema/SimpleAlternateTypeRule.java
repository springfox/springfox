...
public class SimpleAlternateTypeRule implements AlternateTypeRule {
   ...
   */
  public SimpleAlternateTypeRule(ResolvedType original, ResolvedType alternate) {
   ...
   */
  public SimpleAlternateTypeRule(ResolvedType original, ResolvedType alternate, int order) {
