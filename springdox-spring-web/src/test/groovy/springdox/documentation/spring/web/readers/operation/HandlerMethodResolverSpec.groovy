...
import springdox.documentation.spring.web.dummy.models.Parent
import springdox.documentation.spring.web.mixins.HandlerMethodsSupport
...
import static springdox.documentation.spring.web.readers.operation.HandlerMethodResolver.*
