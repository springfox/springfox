...
public abstract class ModelMapper {
  ...
  public Map<String, Model> mapModels(Map<String, springdox.documentation.schema.Model> from) {
    if (from == null) {
      return null;
    }
    ...
    for (java.util.Map.Entry<String, springdox.documentation.schema.Model> entry : from.entrySet()) {
  ...
  public Model mapProperties(springdox.documentation.schema.Model source) {
  ...
  protected Map<String, Model> modelsFromApiListings(Map<String, ApiListing> apiListings) {
    Map<String, springdox.documentation.schema.Model> definitions = newHashMap();
