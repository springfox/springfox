...
import springdox.documentation.schema.Types;


@Mapper
public class ParameterMapper {

  public Parameter mapParameter(springdox.documentation.service.Parameter source) {
    Parameter parameter = bodyParameter(source);
    return serializableParameter(source).or(parameter);
  }

  private Parameter bodyParameter(springdox.documentation.service.Parameter source) {
  ...
  private Optional<Parameter> serializableParameter(springdox.documentation.service.Parameter source) {
