...
import static springdox.documentation.swagger2.mappers.ModelMapper.*;
...
public abstract class ServiceModelToSwagger2Mapper {
  ...
  protected abstract Operation mapOperation(springdox.documentation.service.Operation from);
  ...
  protected abstract Tag mapTag(springdox.documentation.service.Tag from);
  ...
  private Path mapOperations(ApiDescription api, Optional<Path> existingPath) {
    ...
    for (springdox.documentation.service.Operation each : api.getOperations()) {
