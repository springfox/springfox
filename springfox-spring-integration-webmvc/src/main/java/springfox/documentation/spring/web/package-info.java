 ...
 * <p>
 * Builds upon the webmvc and webflux implementations, but uses Spring Integration webflux
 ...
 * <ul>
 * <li>{@code @Conditional(SpringIntegrationNotPresentInClassPathCondition.class)}
 * on {@code DocumentationPluginsBootstrapper} to avoid bootstrapping the documentation
 * plugins twice</li>
