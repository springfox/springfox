...
window.onload = function () {
  ...
  var buildSystemAsync = function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(baseUrl) {
      var configUIResponse, configUI, configSecurityResponse, configSecurity, resourcesResponse, resources, retryURL;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return fetch(baseUrl + "/swagger-resources/configuration/ui", { credentials: 'same-origin' });

            case 3:
              configUIResponse = _context.sent;
              _context.next = 6;
              return configUIResponse.json();

            case 6:
              configUI = _context.sent;
              _context.next = 9;
              return fetch(baseUrl + "/swagger-resources/configuration/security", { credentials: 'same-origin' });

            case 9:
              configSecurityResponse = _context.sent;
              _context.next = 12;
              return configSecurityResponse.json();

            case 12:
              configSecurity = _context.sent;
              _context.next = 15;
              return fetch(baseUrl + "/swagger-resources", { credentials: 'same-origin' });

            case 15:
              resourcesResponse = _context.sent;
              _context.next = 18;
            ...
            case 23:
              ...
              _context.next = 27;
              return prompt("Unable to infer base url. This is common when using dynamic servlet registration or when" + " the API is behind an API Gateway. The base url is the root of where" + " all the swagger resources are served. For e.g. if the api is available at http://example.org/api/v2/api-docs" + " then the base url is http://example.org/api/. Please enter the location manually: ", window.location.href);

            case 27:
              retryURL = _context.sent;
              return _context.abrupt("return", buildSystemAsync(retryURL));
    ...
    return function buildSystemAsync(_x) {
      return _ref.apply(this, arguments);
    };
  }();

  var getUI = function getUI(baseUrl, resources, configUI, configSecurity) {
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return buildSystemAsync(getBaseURL());
