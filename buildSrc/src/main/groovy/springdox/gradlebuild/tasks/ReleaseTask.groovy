...
class ReleaseTask extends DefaultTask {
  @Option(option = 'releaseType', description = "Release type (required)")
  ReleaseType releaseType

  @TaskAction
  void release() {
    assert releaseType: "releaseType is required"
    if (project.gradle.startParameter.dryRun) {
      println "dryRun releasing ${releaseType} ${project.version}"
    } else {
