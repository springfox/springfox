...
public class DummyClass {
  ...
  @ResponseBody
  public Pirate methodToTestBidrectionalRecursiveTypes(@RequestBody Pirate model) {
    throw new UnsupportedOperationException();
  }

  @ResponseBody
  public RecursiveTypeWithConditions methodToTestBidrectionalRecursiveTypesWithConditions(
