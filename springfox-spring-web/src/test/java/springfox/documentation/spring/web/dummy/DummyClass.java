...
import springfox.documentation.spring.web.dummy.models.same.MapFancyPet;
...
public class DummyClass {
  ...
  @ResponseBody
  public MapFancyPet methodToTestSameClassesWithDifferentProperties(@RequestBody FancyPet fancyPet) {
    throw new UnsupportedOperationException();
  }
