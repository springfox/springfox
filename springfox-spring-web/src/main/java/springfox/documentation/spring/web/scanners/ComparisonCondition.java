...
public class ComparisonCondition {
  ...
  public ComparisonCondition(String modelFor, Set<String> modelsTo, Set<String> conditions) {
    ...
    this.modelsTo = ImmutableSet.copyOf(modelsTo);
  ...
  @Override
  public int hashCode() {
    return Objects.hashCode(modelFor, modelsTo, conditions);
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equal(modelFor, that.modelFor) && Objects.equal(modelsTo, that.modelsTo)
