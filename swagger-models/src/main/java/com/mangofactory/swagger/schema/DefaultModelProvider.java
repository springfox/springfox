...
import static com.mangofactory.swagger.schema.Collections.*;
...
public class DefaultModelProvider implements ModelProvider {
  ...
  public com.google.common.base.Optional<Model> modelFor(ModelContext modelContext) {
    ...
    for (com.mangofactory.swagger.schema.property.ModelProperty each : properties(modelContext, propertiesHost)) {
  ...
  private Iterable<? extends com.mangofactory.swagger.schema.property.ModelProperty> properties(ModelContext context,
