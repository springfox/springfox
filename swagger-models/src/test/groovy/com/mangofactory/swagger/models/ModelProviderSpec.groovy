...
class ModelProviderSpec extends Specification {
  ...
  def "dependencies are inferred correctly by the model provider"() {
    ...
    where:
      ...
      genericClassWithGenericField() | ["Charset", "Map«string,string»", "HttpHeaders", "MediaType", "ResponseEntity«SimpleType»", "SimpleType", "URI"].sort()
      genericClassWithDeepGenerics() | ["Charset", "Map«string,string»", "HttpHeaders", "MediaType", "ResponseEntity«List«SimpleType»»", "SimpleType", "URI"].sort()
