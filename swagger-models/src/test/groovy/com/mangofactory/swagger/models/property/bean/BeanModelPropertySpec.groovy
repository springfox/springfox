...
class BeanModelPropertySpec extends Specification {
  ...
  def "Extracting information from ApiModelProperty annotation"() {
    ...
    where:
      ...
      "getIntProp"  || "int Property Field"     | true      | null                                                                                      | "int"     | "int"
      "isBoolProp"  || "bool Property Getter"   | false     | null                                                                                      | "boolean" | "boolean"
      "getEnumProp" || "enum Prop Getter value" | true      | new AllowableListValues(collectionAsScalaIterable(newArrayList("ONE")).toList(), "LIST")  | "string"  | "com.mangofactory.swagger.models.ExampleEnum"
      "setIntProp"  || "int Property Field"     | true      | null                                                                                      | "int"     | "int"
      "setBoolProp" || "bool Property Getter"   | false     | null                                                                                      | "boolean" | "boolean"
      "setEnumProp" || "enum Prop Getter value" | true      | new AllowableListValues(collectionAsScalaIterable(newArrayList("ONE")).toList(), "LIST")  | "string"  | "com.mangofactory.swagger.models.ExampleEnum"
  }
  // @formatter:on
}
