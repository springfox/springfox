...
public class SpringIntegrationRequestHandler implements RequestHandler {
  ...
  public Set<NameValueExpression<String>> headers() {
    return SpringIntegrationNameValueExpressionWrapper.from(requestMapping.getHeadersCondition().getExpressions());
  }

  @Override
  public Set<NameValueExpression<String>> params() {
    return SpringIntegrationNameValueExpressionWrapper.from(requestMapping.getParamsCondition().getExpressions());
  }
