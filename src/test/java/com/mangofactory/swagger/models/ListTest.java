...
public class ListTest {
    ...
    class ToTest {
        ...
        private Iterable<String> nicknames;
        ...
        Iterable<String> getNicknames() {
            return nicknames;
        }

        void setNicknames(Iterable<String> nicknames) {
    ...
    public void hasValidToTestModel() {
        ...
        assertThat(toTest, hasProperty("nicknames", "List"));
        DocumentationSchema nicknameItems = toTest.properties().get("nicknames");
        assertThat(nicknameItems.getItems().ref(), is("string"));
    }
