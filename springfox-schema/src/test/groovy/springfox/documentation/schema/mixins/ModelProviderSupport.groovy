...
class ModelProviderSupport {
  ...
  ModelProvider defaultModelProvider(ObjectMapper objectMapper = new ObjectMapper(),
    ...
    TypeNameExtractor typeNameExtractor = new TypeNameExtractor(typeResolver, modelNameRegistry,enumTypeDeterminer)
    ...
    def modelDependenciesProvider = modelDependencyProvider(typeResolver, modelPropertiesProvider, typeNameExtractor, enumTypeDeterminer)
  ...
  DefaultModelDependencyProvider modelDependencyProvider(TypeResolver resolver,
    ...
    new DefaultModelDependencyProvider(resolver, modelPropertiesProvider, typeNameExtractor, enumTypeDeterminer)
  }
  ...
  DefaultModelDependencyProvider defaultModelDependencyProvider() {
    ...
    def modelPropertiesProvider = new OptimizedModelPropertiesProvider(
        ...
        typeNameExtractor)
    modelPropertiesProvider.onApplicationEvent(event)
    modelDependencyProvider(typeResolver, modelPropertiesProvider, typeNameExtractor, enumTypeDeterminer)
  }
